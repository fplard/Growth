...
Gro_ModSettings <- function(data, random =NULL, mod = "vonbertalanffy") {
  ...
  maxval = list(z0 =  25, zinf = max(data$z)*50, gamma = 20)
...
if(mod == "gompertz"){
  ...
  maxval = list(alpha =  40, zinf = max(data$z)*50, gamma = 20)
  ...
  maxval = list(age0 =  0, zinf = max(data$z)*50, gamma = 20, h= 10, th = max(data$age))
  minval = list(age0 = -20, zinf = 0, gamma = 0, h= -10, th = 0)
  ...
  minval = list(alpha0 =  -20, alpha1 = -20, beta = 0)
  maxval = list(alpha0 = 20, alpha1 = 20, beta = 10)
  ...
  maxval = list(z0 =  25, zinf = max(data$z)*50, gamma = 20, P = 10)
