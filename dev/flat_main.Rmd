...
* `all_mods` a vector of model names. The following models are supported : logistic, gompertz, tpgm, power, richards, vonbertalanffy, and fabens.
...
* all_mods indicating the growth models that need to be fit.The following models are supported : logistic, gompertz, tpgm, power, richards, vonbertalanffy  and fabens. default = "vonBertalanffy"
...
* `data`, a data frame including at least the numeric columns *logx*, *logz* and *IND*
* `random`  name of the parameters that must include an individual random effect
* `mod` Name of the model to fit. The following models are supported : logistic, gompertz, tpgm, power, richards, vonbertalanffy, and fabens
...
test_that(
  "Gro_ModSettings error",
  {
    expect_error(
      ...
      regexp = "The growth models supported are: logistic, gompertz, tpgm, power, richards, vonbertalanffy, and fabens")
    expect_error(
...
test_that(
  ...
  expect_named(a$data_nim, c("logz", "logx"))
